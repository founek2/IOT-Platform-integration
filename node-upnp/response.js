import parser from 'npm:fast-xml-parser@3.21.1'
import he from 'npm:he@1.2.0'
import eventsValues from './events.js'
...
export function parseDeviceDescription(xmlString, url) {
  url = new URL(url);
...
export function parseServiceDescription(xmlString) {
...
export function parseSOAPResponse(xmlString, actionName, outputs) {
...
export function parseTimeout(header) {
